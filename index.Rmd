...
source("R/run_prisma_pipeline.R")
  ...
  source("R/manual_classifications.R") 
  source("R/automated_exclusions.R")
  source("R/final_classification.R")
  source("R/prisma_stats.R")
  source("R/export_results.R")
  source("R/prisma_flow_output.R")
...
We provide a summary of the papers with `summarise` from [@R-dplyr]. 
...
We identify prevalent methodological approaches using frequency analysis and `tidyr` [@R-tidyr] for data restructuring.
